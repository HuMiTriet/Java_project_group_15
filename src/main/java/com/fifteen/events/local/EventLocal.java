 ...
 * event will be stored locally inside our local.db file and will be sync to the
 * remote database every time the user click the sync button or exit the page
 * using the exit button. Each event will have an event ID to unique identify
 * it, the ID is created by the user email_a unique ID
